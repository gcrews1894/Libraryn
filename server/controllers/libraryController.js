...
libraryController.addLibrary = (req, res, next) => {
    ...
    const {book_id} = res.locals.book
    console.log(req.body);
    const params = [user_id, book_id, borrower, condition];
    db
      .query(addToLibrary, params)
      .then((data) => {
  ...
  //     })
  //   const params2 = [ user_id, book_id, borrower, condition ]
  //   db
  //   .query(addToLibrary, params2)
  //   .then((data) => {
